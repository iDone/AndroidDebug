            ...
            if (Process.pointerSize == 4) {
                ...
                for (var j = 0; j < section.size / 4; j++) {
                    ...
                    if (F + module.vmmin != M && F != M) {
						...
						if (msym.funcname != fsym) {
							console.log(".got " + j + "/" + section.size / 4 + "\taddr:" + (section.memaddr + j * 4).toString(16) + " file-mem:" + F.toString(16) + "-" + M.toString(16) + " " + fsym + "->" + msym.libname + "." + msym.funcname);
						}
                    }
                }
            } else {
                ...
                for (var j = 0; j < section.size / 8; j++) {
                    ...
                    if (F + module.vmmin != M && F != M) {
						...
						var fsym = module.sym_2_str[module.dyn_2_name[section.memoff + j * 4]];
						if (msym.funcname != fsym) {
							console.log(".got " + j + "/" + section.size / 8 + "\taddr:" + (section.memaddr + j * 8).toString(16) + " file-mem:" + F.toString(16) + "-" + M.toString(16) + " " + fsym + "->" + msym.libname + "." + msym.funcname);
						}
                    }
                }
            }
            ...
            if (Process.pointerSize == 4) {
                ...
                for (var j = 3; j < section.size / 4; j++) { // First 3 is special
                    ...
                    if (F + module.vmmin != M && F != M) {
						...
						var fsym = module.sym_2_str[module.dyn_2_name[section.memoff + j * 4]];
						if (msym.funcname != fsym) {
							console.log(".got.plt " + j + "/" + section.size / 4 + "\taddr:" + (section.memaddr + j * 4).toString(16) + " file-mem:" + F.toString(16) + "-" + M.toString(16) + " " + fsym + "->" + msym.libname + "." + msym.funcname);
						}
                    }
                }
            } else {
